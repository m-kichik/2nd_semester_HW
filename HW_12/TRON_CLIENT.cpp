...
private:
    ...
    inline static const std::size_t m_cell_size = 3U;
    ...
    Player server_player = { {10., 10.}, Direction::up, {204, 102, 255} };
    Player client_player = { { m_field_width - 10U, m_field_height - 10U}, Direction::down, { 255, 102, 0 } };
...
int main()
{
    ...
    background_texture.loadFromFile("../tron/images/background.jpg");
    Sprite background(background_texture);

    auto retVal = 0;

    std::cout << "Initializing the game" << std::endl;
    retVal = TronMaker(background).start();
